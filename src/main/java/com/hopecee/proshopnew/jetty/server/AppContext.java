...
public class AppContext {
    ...
    private static String resourceBase1 = "src/main/webapp";
    private static String resourceBase2 = "src/main/java";
    private static String resourceBase3 = "target";
    private static String resourceBaseImg = "E:\\proShopDir";
...
//AsyncConnection AsyncConnection = new AsyncConnection();
        ...
        String[] res = new String[]{resourceBase1, resourceBaseImg
